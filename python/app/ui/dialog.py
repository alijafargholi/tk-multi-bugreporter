...
"background: none;")
        ...
        self.lower_layout.addItem(spacerItem1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.bold.setText(QtGui.QApplication.translate("Dialog", "Bold", None, QtGui.QApplication.UnicodeUTF8))
